...
class BOARD:
    ...
    LED  = 23   # RaspPi GPIO 23 connects to the LED and a resistor (1kohm or 330ohm)
    SWITCH = None # RaspPi GPIO 4 connects to a switch - not necessary
    ...
    def add_events(cb_dio0, cb_dio1, cb_dio2, cb_dio3, cb_dio4, cb_dio5, switch_cb=None):
        ...
        if (BOARD.SWITCH is not None) and (switch_cb is not None):
